...
## 更新记录
- 20260126：标题从基础设施、调整为软件工程，日期从20200315、调整为20240630。一方面，纪念24年认知飞跃，另一方面找一个更大的方向、继续更新
...
- 技术
    ...
    - 通信：
        - 将智能体封装为MCP工具，这种做法是有局限性的，因为它无法发挥智能体的全部功能；正确姿势是A2A
- 产品
    - 交互
        - 目标：AI Native的人机交互界面
            - 要求：即时(AI反应要快)
        - 交互设计：对话+GUI深度融合。备选特征如下，
            - [?]多元化的触发机制
            - [X]上下文感知
            - [X]多模式对话
        - 视觉设计：侧边栏集成，轻量化和隐形化。备选特征如下，
            - [?]响应式和自适应(用户画像)
            - [?]分阶段多模态
        - 重大变数：脑机接口，全息交互，情感计算 => 从根本上改变人机交互方式
- 名词
    - 组织：单人公司、硅基搭子


#### 2026.02.03 智力资源的工业化
智力资源的开发与应用，此前长期处于个体化、经验化的手工作坊模式，AGI推动其实现标准化、流程化与工业化转型。

以科研为例，AGI以标准方式承接繁重重复、低创造性的工作，人类科学家保留低频但高阶的工作，从而科研全链路的标准化程度显著提升。当然，AGI并非只参与前端科研，而是渗透到`科研-中试-产业化`的科研转化全链路，在各环节承接低阶重复工作、打通跨环节信息壁垒、提升全流程标准化效率，从而压缩转化周期、降低转化成本。


智力资源被工业化后，人类还有哪些独特价值？大类如创造建构、体验感知、精神超越、联结互动。如下，
...
#### 2026.02.03 如何理解多模态
如何理解多模态？以生物人类比，推理模型就是大脑，多模态模型是眼睛、耳朵等外部感官。

LLM是大脑中枢，负责逻辑推理、语言理解；多模态模型是感官系统，把视觉、听觉等外部信息转化为大脑能处理的统一语言，最终实现"感知+理解+推理"的一体化。


#### 2026.01.13 OpenAI的AGI能力分级

|级别|英文名称|中文名称|核心能力|典型特征|代表/示例|
| ---- | ---- | ---- | ---- | ---- | ---- |
|L1|Chatbot/Conversational AI|聊天机器人|自然对话、多模态交互|流畅处理文本/语音/图像，被动应答，无自主行动能力|ChatGPT 3.5/4基础对话、多模态交互|
|L2|Reasoner|推理者|人类级逻辑推理、复杂问题求解|可完成数学证明、代码编写、多步骤推导，无自主调用工具能力|具备博士级逻辑推导水平，解决复杂数学题、写复杂代码|
|L3|Agent|智能体|数字环境自主行动、工具调用、任务规划|独立完成复杂目标，调用API/工具，自主调整策略，持续执行|自主谈判合同、监控生产线并优化能耗、规划行程|
|L4|Innovator|创新者|原创性成果产出、辅助发明创造|提出新理论、设计新方案、产出突破性创意/技术|助力药物研发、新材料发现、提出全新科学假设|
|L5|Organizer|组织者|统筹多智能体、战略管理、组织级运营|独立完成整个组织工作，制定长期战略，优化全流程|运营企业、管理城市系统，统筹多智能体协作达成宏大目标|


#### 2025.12.10 AI原生思维
AI原生思维：不要问"这项工作哪里可以AI提效"、而是要想"如果这项工作彻底由AI接手，它会长成什么样"。

麦肯锡报告显示，把AI当成工具插在现有流程里，只能得到10%的“量变优化”；由AI主导重塑流程，让人退居到监督者的位置，才能获得90%的“质变优化”。把AI对企业的改变，分成3个层次：

第一层，仅仅作为辅助软件。比如帮员工检索知识库，起草回复。效率可以提高10%。

第二层，嵌入流程，但并没有重塑流程。比如，用AI自动归类数据。效率可以提高30%。

第三层，AI重塑工作流。效率提高了75%，并且有80%的问题可以自动被解决。


#### 2025.10.31 基建的AGI转型
基建AGI转型，保守姿势是 `用AGI的方式、重做一遍基建`。具体的，

- 已标准化的：继承云原生的优质遗产，通过AGI ①提升交付效率、②降低运营成本；
- 未标准化的：通过AGI，降低标准化门槛、提升覆盖(将更多对象纳入体系)。

进取的姿势是，`重新定义基建，拓展基建边界`，获得更广阔的空间。
...
#### 2026.07.30 中台的顶层视角
组织上，中台即管理手段。要云产品化、利润中心化，以中台资源、为CEO创造控制和治理手段。

目标上，合理管控预期。要明确目标的约束条件，对上、对Peer达成一致，中台难做、避免自己被不明不白的干走。


#### 2026.01.15 技术体系的建设之道
如何构建一个技术体系？体系构建，遵循先归纳、后演绎，一般需要1-3年的周期。

以体系正式命名为界，前期是小范围的实践和总结(归纳)，后期是大范围的推广和完善(演绎)。正式命名的那一刻，顿悟式的灵光乍现很关键，命名背后的语言权利也很关键。

知识体系也有类似方法。灵感乍现记卡片(积累)，定期整理做分类(聚类)，厚积聚合成体系(归纳)；跨界迁移是创新(演绎)。从卡片笔记到第二大脑，知识从碎片聚化为体系。


#### 2026.01.12 工程系统的自洽模型
工程系统，遵循`输入-处理-输出`IPO模型，输入物质(Matter)、能源(Energy)，经由信息(Information)系统的处理，输出人类所需的特定功效。MEI，是客观世界的三大基本要素。

建设阶段，优雅架构。首要标准是信息要素的充分提取、体现与固化，其次需兼顾物理层的容灾容错、系统层的自洽协同。

运营阶段，理想运营形态是全自动化。**输入能源和物质、输出稳定功效，全程无需例外补充(如人工参与或修复)**。建设阶段的优雅架构，有利于实现理想运营形态。

出门左转，将信息系统、更名为智能系统，自洽模型在AI时代依然成立。
...
数字孪生(Digital Twin)，本质是：把物理对象建模、搬到数字空间做分析，并把分析结果、作用回物理对象。关键点包括领域建模(模型)、指标采样(数据)、挖掘分析(算法)、结果应用等，如下图。其中，模型可复购、算法可升级，只有数据必须长在物理实体上 —— 为数据付费。
...
>>> 2023.08.09 数据孪生的终态，很可能是镜像世界，即在数字世界中、重建人类文明；物理世界已经触及物理规律的极限，数字世界的极限远远未到。

>>> 2025.10.09 只有优质对象才值得投入、实现数据变现，比如系统复杂、数据密集、迭代成本高的核心领域。

>>> 2026.06.22 AGI加速数字世界的到来，对于数字对象和孪生服务，前期辅助人类、提效加速，后期则跳出人的限制、推高上限；数字孪生模型，没有本质变化。

![pict.png](https://raw.githubusercontent.com/niean/niean.github.io/master/images/20200315/digital-world.png)
...
#### 2025.12.31 云厂商协作的技术底线
厂商协作，云产品能力不Ready时，推厂商改造、还是我方适配？基本原则是什么？
...
#### 2025.11.19 云厂商是顶级基建
Cloudflare的全球故障，引发了很多思考。马工的观点，也是我的感受，如下：

- 问题：云厂商 责任和影响力不对等。典型如故障赔偿，只计算直接损失、不考虑次级或三级连带损失；
- 解法：云厂商 应该被纳入基建监管。云厂商应该和银行、电信、发电厂一样，升级为顶级基建，接受国家和社会的严格监管。
...
- 更新记录20220711：上述观点之争，就是「甲方追求实用、创投追求先进」的一个典型，两者是站在不同的时代、思考同一个问题。放眼将来，大部分IT职能会聚集到头部SaaS厂商，IT服务会变的高度标准化、个性化会被模块化组件抹平，IT部门也将随之弱化
...
更新记录20220712：组织、资源、数据的集约化，为运维管理做好了组织准备。之后，需要将运维能力服务化OPaS，运维通过平台、和上下游业务相互依赖，这是技术目标。
...
更新记录20210713：运维面(ToM)沉淀了适量流程规范，是全局视角的操作习惯；再往上还有用户面(ToC)，结合了严格流程规范，是适合RD的应用视角。
...
更新记录20220713：规范落地 要依赖强大的中心权威，寄希望于个体自觉是非常不靠谱的。对于外延规范，中心权威能被平台替代；对于元数据，中心权威不可替代。
...
## 管理
#### 2026.08.08 制度局限即组织上限
反思前东家的组织管理，有如下几个典型问题：

- 物化管理：压力自上而下、涟漪传导，创始人→高管→中层→基层；中层既是执行人，也是上层压力承接者，两头受困、尤难自处。
- 技术集权：短期提效、长期毒药，中基层被工具化、主动性与创造力严重蜕化。
- 微操失当：越俎代庖、亲自下场，管控信息、吝于授权，和下级争抢资源空间；此类认知错位、管理失能，缺乏制度约束。

此皆制度之弊，非人之过也。制度局限即组织上限，我闭目塞听、坚守三年，终究是错付了。


#### 2026.07.02 物化管理
物化管理：运用工具理性，把人物化为资源，用数字盈亏、资源损耗来核算经营收益。

针对组织中的绝大部分个体，实施物化管理；顶端的一小撮人，保留人本和温情。这种二元格局，是集权模式+管理能力到达极致的表现。物化管理并不妨碍公司业务的成功，只要它的顶层保持健康，只要它看中稳定胜过进化。

秉持人本初心的个体，在管理实践中会不断滑向物化，为何？也许是误入了鲍鱼之肆。


#### 2026.02.02 横向思维反思
横向格局：横向思维催发的格局，是淳朴的、原始的、低阶的格局。

横向格局，本质不是看清终态后的利他主义，而是无知状态下的共情泛滥、是资源富态下的边界缺失。服务好大局，首先要做好自己，之后的利他行为、才是真格局。

横向格局，曾让我引以为傲，诸如服务者心态、成事的态度，可谓豪气干云；但又将我拖入深深的内耗，事前不好意思拒绝，拒绝后又陷入懊恼和闪回。乡土社会的人情世故，加剧了这份格局的危害，如被人利用做PUA。


横向解构：横向事务的解构重组，路径是 拆解横向事务 -> 提取通用要素 -> 按纵向目标重组 -> 沉淀纵向能力。

技术专业，首先由纵向构成、而不是横向。针对横向Toils，要解构、重组为纵向目标。

具体的，解构横向工作，认识到它的相对性、存在性、局限性，并合理转化。包括，
...
#### 2025.12.31 管理的陷阱
回首2019到2022年的管理经历，高材低就、自省式PUA，简直猪狗不如。今天管理觉醒了，记在这里。

- 组织设计：高效的组织建设，靠的是正向的职能设计、人才筛选，而不是以下级为中心的公私边界模糊、温情讨好、兜底提拉。PUA管理者高材低就、接受环境错配，且美其名曰培养的，始作俑者其无后乎
- 温情管理：对人包容，不应等同于对事纵容。温情管理者，要配上刚性的规则框架，实现`刚性对事+温情待人`的双轨，警惕因姿态过低、而沦为粪坑

认知不够时受的欺负，得认下。原谅、放下，继续奔赴下一场山海。
...
更新记录20251231：信息即权利。观测过于全面(or暴露)，不但有损决策权(外行干涉)、还加剧了主R压力(暴露更多underlay)，专线方向尤其明显。怎么破？消除半吊子决策，首先要避免创造出半吊子的人，信息暴露要把握好度
...
## 个人
#### 2025.11.03 职场倦怠
不知不觉，经历了第一次职场倦怠，体会到了格局骤降、认知窄化，生不如死。

事后复盘，这场倦怠持续了3个月，症状跟长假或远足的后半程类似。根因可能不是职场疲倦、不是家庭拖累、不是过度学习等，而是中短期目标缺失 —— 忙的太甚太久，以至于忘了初心。

眼中无光的日子，实在太可怕了；人生目标、价值、意义感，于我而言就是第一动力、第一原理。感谢自己那一刻的觉醒，愿不再迷失。
...
更新记录20220714：之前更重视形式上的总结，对体系化产出并未做要求。这样不对。体系化产出才是目标，应该更被重视，按照这个要求做了半年、效果显著。
...
更新记录20220713：Ops和SRE的区别，在于组织、分工、技术架构，很少在于主观能动性。康威定律。
