...
#### 2026.07.02 物化管理的反思
物化管理：把人物化为资源，用数字盈亏、决策汰换。

组织是人的集合。物化管理，针对组织中的绝大部分个体；但顶端的一小撮人，保留了人本和温情。这种二元格局，是`集权模式+管理能力`发展到极致后的表现形态。

从结果看，物化管理并不妨碍公司业务的成功，只要它的顶层保持健康、只要它追求稳定胜过进化。

作为个体，我理性上尊重温情、反对物化，但在管理实践中不断滑向物化。为何？`与恶人居，如入鲍鱼之肆，久而不闻其臭`，误入而已!
