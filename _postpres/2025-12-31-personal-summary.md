...
# 成长节点
- 19H2 
    - 经典运维：延续滴滴的运维方法论，抱死稳定性，代工、服务者心态+成事的态度，主打苦劳
- 20H2 
    - 管理框架：绿宝书输入了选用育励汰的五步模型，自此组织思维、管理实践缓慢但正向的发育
- 21H2 
    - 提出OPaS：21年SRE放弃研发代工的定位，专注于平台工程、运维服务化(IDP)；23年SYS放弃资源管家的定位，专注于云管平台、资源服务化(ICSP)；24年横向解构Toils，OPaS理论建设完成
- 22H2 
    - 体系实践：22年先后搞定了FinOps、CM，体系化 先有实践结果、1年后才提出理论
- 23H1 
    - 领域觉醒：开始追求OP独立价值，不再被带节奏、不做架构之余；分工越来越明，协作越来越难(改革的代价)
- 23H2 
    - 工程质量：系统输出培养体系，涉及理论、工程、管理等，针对人的工程质量体系1年后达到成熟
- 24H1 
    - 外部输入：得到取代工作、成为最大的成长动力，抽象出个人成长模型，之后1年持续反补工作。得到的知识输入，促使认知格局提升了1-2档
    - 管理觉醒：摆脱自省式PUA，安心淘汰落后人员、营造先进环境，不再为低阶的人和事兜底。认知不够时受的欺负，得认下
- 24H2 
    - 数据基建：提出DIaC，从FinOps孵化出OLAP技术栈，之后广泛应用到资源观测、业务洞察
    - 精益运营：提出ODD，去技能化、运营驱动开发，尝试用低阶人才、维持复杂系统；23H2开始孵化，25H1基本成熟
- 25H2 
    - 管理体系：从20年输入管理理论开始，5年内探索除了分工、例外、目标、审阅、去技能化、工程质量，25H2升级为组织工程
    - 基建AGI：一线实践、理论建设的螺旋式演进，宏大建制、领域、架构等高阶能力终于成熟
...
- 体系建设
    ...
    - 24H1 管理觉醒，摆脱自省式PUA，安心淘汰落后人员、营造先进环境，不再为低阶的人和事兜底。认知不够时受的欺负，得认下
...
- 体系建设
    ...
    - 23H2 工程质量，系统整理了工程质量之培养体系，涉及理论、工程、管理等，1年后达到成熟

### 22
- 方向规划：SRE真正落实了OPaS，开始规划驱动、体系化产出，部分跳出温情管理的恶性循环
    - OPaS继续完善，明确技术对象、场景，拆分领域职责(如子网去应用化)，刻意去横向(如项目轮流主持)
- 团队管理：感受到人才梯度制约，尝试强化规则来兜底人，如月度重点附带成长要求(红字)、结果验收升级为独立第三方。依然以下级为中心
    - 事后看，直到24年才开始主动淘汰不合格成员，真正摆脱以下级为中心的管理模式
- 技术成长：工程质量，开始尝试左移、包括开发规范，模式上没有太大突破
- 体系建设
    - 22H2 体系产出，22年先后搞定了FinOps、CM，体系化先有了实践结果、理论1年后才被明确提出
...
- 技术成长：工程质量，开始推进工具中台、低代码、开源引入，为OPs参与开发创造条件
- 体系建设
...
- 体系建设
    - 19H2 经典运维，延续滴滴的运维方法论，抱死稳定性，代工、服务者心态+成事的态度，主打苦劳
...
- 个人
   - 祛魅：互联网应用技术无壁垒。大部分时候，你只需要大声说出新概念、新名词，就能唬住吓退很多人，从而在不增加核心竞争力的情况下筑高壁垒。对此，需要有意去神秘化
...
- 管理
    - 组织：梯度，管理者要为结果负责，但这并不意味着牺牲自己、长期兜底组织缺陷，凯撒的归凯撒、上帝的归上帝
        - >> 20260114按：终于明确反对粪坑了，终于不再委屈自己，非常正确
...
- 专业
    ...
    - 领域：领域划分答案不唯一，受限于组织结构、技术实现、业务场景等；领域划分是一个折中权衡的过程，没有绝对正确、只有相对合理
        - >> 20260114按：规范、治理、度量、领域，说的都是一件事，`领域觉醒，OP不希望再被带节奏、不愿再做架构之余`
...
- 个人
    ...
    - 技术：方向大定，高维成长停滞，只能在小纵向寻求安慰
        - >> 20260114按：自认高维成长停滞时，其实才刚刚胜任运维TL岗。永远不满足、永远渴望更上一层楼，感谢自己的这份雄心壮志
...
- 专业
    ...
    - 工程质量：在强压之下工程质量有所提升，但尚未形成意识自觉，监督落地成本挺高 —— 掰嘴喂食是人才筛选问题的延续
        - >> 20260114按：此时已明确感受到，人才梯度靠筛选、而非培养
